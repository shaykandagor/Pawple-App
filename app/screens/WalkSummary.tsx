        ...
        <ScrollView>
            <Card style={[styles.cardContainer]}>
                <View style={{width: "100%", height: "100%"}}>
                    ...
                    <List.Item title="PickUp" description={() =>
                        <View>
                            <Text style={{color: Colors.neutralDark, fontSize: 16}}>13:42</Text>
                        </View>
                    }
                        right={(props) =>
                            <Text {...props} style={{color: Colors.textDark, fontSize: 30, fontWeight: "500"}}>1.2 km</Text>
                        }
                        left={
                            () =>
                                <MaterialCommunityIcons name='origin' size={20} style={{color: Colors.primary, paddingLeft: 20}} />
                        }
                    ...
                    <List.Item
                        ...
                        left={
                            () =>
                                <MaterialCommunityIcons name='map-marker' size={20} style={{color: Colors.primary, paddingLeft: 20}} />
                        }
                    ...
                    <View style={styles.content}>
                        <Text style={{color: Colors.textDark, fontSize: 20, fontWeight: "600"}}>Rate your walker</Text>
                    </View>

                    <View style={{padding: 20}}>
                        <View style={{backgroundColor: Colors.primary, padding: 10, flexDirection: "row", borderRadius: 20, alignItems: "center", justifyContent: "space-evenly"}}>
            ...
            <Card style={styles.payment}>
                <Text style={{color: Colors.textDark, fontSize: 20, fontWeight: "500", padding: 20}}>Payment</Text>
                ...
                <View style={styles.submitButton}>
                    <ClickButton mode="outlined" title="Get help with walk" onPress={() => {console.log("Pressed")}} />
                </View>
