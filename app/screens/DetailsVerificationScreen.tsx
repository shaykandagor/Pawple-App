...
const DetailsVerificationScreen: React.FC = () => {
  const validationSchemer: ObjectSchema<DetailsFormValues> = YUP.object().shape({
    name: YUP.string().label('name').required(),
    ssn: YUP.string().label('number').required()
  })
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Form
        ...
        onSubmit={(value) => {
          console.log('DetailsForm values', value)
        }}
      ...
      >
        ...
        <View style={styles.inputs}>
          <FormTextInput
            name="name"
            inputProps={{ label: 'Full Name', mode: 'outlined', inputMode: 'text' }}
          />
        </View>
