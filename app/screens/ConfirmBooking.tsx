...
const ConfirmBookingScreen: React.FC<ConfirmBookingScreenProps> = ({navigation}) => {
    const screenHeight = Dimensions.get("screen").height
    return (
        <ScrollView>
            <Card style={[styles.cardContainer, {height: screenHeight * 0.3}]}>
                <View style={{width: "100%", height: "100%"}}>
                    <List.Item title="Milo" description={() =>
                    ...
                    } right={(props) => <Avatar.Image {...props} source={require('../assets/pet_profile.jpg')} />} />

                    <Card.Content>
                        <Text style={{color: Colors.textDark, fontSize: 16}}>Pick up</Text>
                        <Text style={{color: Colors.neutralDark, fontSize: 16}}>Apt No. 420, Suintionkatu Rd, Alppila</Text>
                    </Card.Content>
            ...
            <Form
                ...
                onSubmit={(value) => {
                    navigation.navigate(ScreenRoutes.WALK_SUMMARY)
                    console.log(value);
                }}
            ...
            >
                <View style={styles.content}>
                    <View style={styles.checkbox}>
                        <Text style={{color: Colors.textDark, fontSize: 20, fontWeight: "500"}}>Requests</Text>
                        <FormCheckbox name="park" label="Go to a dog park" />
                        <FormCheckbox name="bags" label="Bring disposable bags" />

                        {/* <View style={{flexDirection: "row"}}>
                                <Text style={{color: Colors.primary, fontSize: 18}}>Chargeable</Text>
                                <FormCheckbox name="bags" label="Bring disposable bags" />
                            </View> */}

                        <Divider />
                        <Text style={{color: Colors.textDark, fontSize: 20, fontWeight: "500", paddingBottom: 10, paddingTop: 10}}>Special Instructions</Text>
                        <FormTextInput name="instructions" placeholder='Type a custom instruction for your dog walker here' />
                    </View>
                </View>

                <View style={styles.content}>
                    <Text style={{color: Colors.textDark, fontSize: 20, fontWeight: "500", padding: 10}}>Payment</Text>
